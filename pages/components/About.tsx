...
const About = () => {
  ...
  return (
    <div id="About" className="px-8 md:px-32 pb-32 content-center bg-gradient-to-r from-teal-600 to-indigo-400">
      ...
      <div className="mt-16 flex flex-col md:flex-row align-center items-center">
        ...
        <div className="pt-8 md:py-0 md:w-1/2 text-white md:ml-4 text-center md:text-left">
          ...
          <div className="mt-6 mx-auto md:mx-0 border-2 border-white py-1 px-2 w-36 text-center font-bold">
            <a className="about__resume text-white text-l" href={about.pdf} download="Resume" target="_blank" rel="noreferrer">Download Resume</a>
          </div>
        </div>
      </div>
    </div>
