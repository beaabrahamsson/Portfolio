          ...
          {projects.projects.map((item) => (
            <li key={item.title} className="flex flex-col lg:flex-row mt-12">
              <div className="lg:w-1/3">
                ...
                {item.url && (
                <div className="text-md text-center font-semibold p-0.5 bg-gradient-to-r from-teal-600 to-indigo-400">
                  <a href={item.url} target="_blank" rel="noreferrer">
                    <div className="bg-white">
                      <span className="block py-0.5 px-2 bg-white bg-gradient-to-r from-teal-600 to-indigo-400 bg-clip-text text-transparent">
                        See Project
                      </span>
                    </div>
                  </a>
                ...
                {item.github && (
                  <div className="bg-white ml-2 font-semibold">
                    <a href={item.github} target="_blank" rel="noreferrer">                      
                      <span className="block py-1 px-2 bg-white bg-gradient-to-r from-teal-600 to-indigo-400 bg-clip-text text-transparent">
                        Source Code
                      </span>
                    </a>
                  </div>
